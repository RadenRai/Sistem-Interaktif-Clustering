...
import { useGetTransactionnsQuery } from "state/api";
...
const Transactionns = () => {
  ...
  // get data
  const { data, isLoading } = useGetTransactionnsQuery({
    page,
    pageSize,
  ...
  return (
    <Box m="1.5rem 2.5rem">
      {/* Header */}
      <Header title="HASIL ITERASI 1" subtitle="" />
      ...
      >
        ...
        <StatBox
          title="Positif"
          value={<div style={{ textAlign: 'center' }}>0.19989596</div>}
        ...
        <StatBox
          title="Sembuh"
          value={<div style={{ textAlign: 'center' }}>0.19968144</div>}
          description="Pusat Cluster 0"
          icon={
            <HealthAndSafetyOutlined
              sx={{ color: theme.palette.secondary[300], fontSize: "26px" }}
        ...
        <StatBox
          title="Meninggal"
          value={<div style={{ textAlign: 'center' }}>0.15413534</div>}
          description="Pusat Cluster 0"
          icon={
            <CloseOutlined
              sx={{ color: theme.palette.secondary[300], fontSize: "26px" }}
        ...
        <StatBox
          title="Positif"
          value={<div style={{ textAlign: 'center' }}>0.75586995</div>}
        ...
        <StatBox
          title="Sembuh"
          value={<div style={{ textAlign: 'center' }}>0.7553391</div>}
          description="Pusat Cluster 1"
          icon={
            <HealthAndSafetyOutlined
              sx={{ color: theme.palette.secondary[300], fontSize: "26px" }}
        ...
        <StatBox
          title="Meninggal"
          value={<div style={{ textAlign: 'center' }}>0.52403983</div>}
          description="Pusat Cluster 1"
          icon={
            <CloseOutlined
              sx={{ color: theme.palette.secondary[300], fontSize: "26px" }}
        ...
        <StatBox
          title="Positif"
          value={<div style={{ textAlign: 'center' }}>0.44315363</div>}
        ...
        <StatBox
          title="Sembuh"
          value={<div style={{ textAlign: 'center' }}>0.44252107</div>}
          description="Pusat Cluster 2"
          icon={
            <HealthAndSafetyOutlined
              sx={{ color: theme.palette.secondary[300], fontSize: "26px" }}
        ...
        <StatBox
          title="Meninggal"
          value={<div style={{ textAlign: 'center' }}>0.33355263</div>}
          description="Pusat Cluster 2"
          icon={
            <CloseOutlined
              sx={{ color: theme.palette.secondary[300], fontSize: "26px" }}
        ...
        <StatBox
          title="Cluster 0"
          value={<div style={{ textAlign: 'center' }}>126</div>}
        ...
        <StatBox
          title="Cluster 1"
          value={<div style={{ textAlign: 'center' }}>37</div>}
          description="Jumlah Data"
          icon={
            <DataArrayOutlined
              sx={{ color: theme.palette.secondary[300], fontSize: "26px" }}
        ...
        <StatBox
          title="Cluster 2"
          value={<div style={{ textAlign: 'center' }}>104</div>}
          description="Jumlah Data"
          icon={
            <DataArrayOutlined
              sx={{ color: theme.palette.secondary[300], fontSize: "26px" }}
